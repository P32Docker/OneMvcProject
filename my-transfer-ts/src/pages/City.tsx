            ...
            <div className={"w-full p-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4"}>

                {
                    data?.map((item, index:number) => (
                        <div
                            key={index}
                            className="max-full bg-white rounded-xl shadow-md overflow-hidden border border-gray-200 flex flex-col transition-colors duration-200"
                        >
                            <img
                            ...
                            <span className="inline-block px-2 py-1 text-xs font-medium bg-blue-100 text-blue-700 rounded-md">
                              {item.slug}
                                ...
                                <p className="mt-1 text-gray-600-100 text-sm ">
                                    {item.country}
                                </p>
                                <button

...
import { forgotPasswordRequest } from '../services/accountService';
        ...
        try {
            ...
            if (data) {
                if (data.Errors && data.Errors.Email) {
                    ...
                    setServerError(data.Message || data.message);
                } else {
                    setServerError("Не вдалося знайти користувача або помилка сервера.");
                }
            }else {
